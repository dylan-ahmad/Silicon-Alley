    ...
    public void Initialize(ModContext context)
    {
        ...
        var options =
            new ModOptions()
                ...
                .AddSlider(SliderSaveKey, "sliderinmydms_slider_label", -100, 100, _sliderValue, OnSliderValueChanged, "sliderinmydms_slider_value")

                .AddSlider(SliderNoSuffixSaveKey, "sliderinmydms_slider_no_suffix_label", 0, 10, _sliderNoSuffixValue, OnSliderNoSuffixValueChanged)

                .AddDropdown(DropdownSaveKey, "sliderinmydms_dropdown_label", DropdownChoices, _dropdownIndex, OnDropdownValueChanged)
